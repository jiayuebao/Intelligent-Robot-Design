// ======================================================================
// Cruise.v generated from TopDesign.cysch
// 04/21/2017 at 16:43
...
module CharLCD_v2_10_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bd661f9e-b48d-49bf-88f7-4d568c2e3832/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_SEQ_P4_v2_20_6 (
	...
	cy_clock_v1_0
		#(.id("b1082717-fd52-4f0e-90d7-418831b7c74b/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b1a1a501-6f34-4711-a3f5-7419b718ae41"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("12dc045e-cb00-4aa1-912f-3a0656a2cbe4"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("2cfdcd2e-00b8-43b4-9be9-c3bc8d8c3ef1"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("972cc274-769b-4b40-9489-c8dcd47ed1b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("45cad4bc-e3b7-494e-a21e-13d4dea26f76"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("333333333.333333"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("09d4abfa-0c4d-44f3-8a67-7e55f99c51ee"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("061c08c3-c4f3-47c0-8cc1-c21a12334063"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("5b6511ae-05e3-491c-81af-64e867e97f2c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
    ...
    ADC_SAR_SEQ_P4_v2_20_6 ADC_SAR_Seq (
        .Vref(Net_111),
        .sdone(Net_112),
        .eoc(Net_760),
        .aclk(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("99259abb-b15e-425c-83dc-c0b6c5c22967"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_L_net;
	wire [0:0] tmpFB_0__Pin_L_net;
	wire [0:0] tmpIO_0__Pin_L_net;
	wire [0:0] tmpINTERRUPT_0__Pin_L_net;
	electrical [0:0] tmpSIOVREF__Pin_L_net;

	cy_psoc3_pins_v1_10
		#(.id("d019f26d-9a0b-42b7-bb7a-31a0c307e46f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pin_L
		 (.oe(tmpOE__Pin_L_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_L_net[0:0]}),
		  .analog({Net_727}),
		  .io({tmpIO_0__Pin_L_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_L_net),
		  .interrupt({tmpINTERRUPT_0__Pin_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_M_net;
	wire [0:0] tmpFB_0__Pin_M_net;
	wire [0:0] tmpIO_0__Pin_M_net;
	wire [0:0] tmpINTERRUPT_0__Pin_M_net;
	electrical [0:0] tmpSIOVREF__Pin_M_net;

	cy_psoc3_pins_v1_10
		#(.id("ebf57eea-a561-4ab0-9552-76466e32db1b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Pin_M
		 (.oe(tmpOE__Pin_M_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_M_net[0:0]}),
		  .analog({Net_1077}),
		  .io({tmpIO_0__Pin_M_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_M_net),
		  .interrupt({tmpINTERRUPT_0__Pin_M_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_M_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
