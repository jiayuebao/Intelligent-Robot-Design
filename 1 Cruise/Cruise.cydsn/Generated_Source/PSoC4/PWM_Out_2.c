...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        PWM_Out_2_PC =   (PWM_Out_2_PC & \
                                (uint32)(~(uint32)(PWM_Out_2_DRIVE_MODE_IND_MASK << (PWM_Out_2_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (PWM_Out_2_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(PWM_Out_2__0__SHIFT, mode);
}
