...
#define QuadDec_1_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
#define QuadDec_1_PWM_MODE_ASYM                  (QuadDec_1_CC_MATCH_INVERT       |   \
                                                         QuadDec_1_OVERLOW_SET           |   \
                                                         QuadDec_1_UNDERFLOW_CLEAR)
...
#define QuadDec_1_QUAD_SIGNALS_MODES                                                             \
...
#define QuadDec_1_PWM_SIGNALS_MODES                                                              \
...
#define QuadDec_1_TIMER_SIGNALS_MODES                                                            \
...
#define QuadDec_1_TIMER_UPDOWN_CNT_USED                                                          \
                ((QuadDec_1__COUNT_UPDOWN0 == QuadDec_1_TC_COUNTER_MODE)                  ||\
                 (QuadDec_1__COUNT_UPDOWN1 == QuadDec_1_TC_COUNTER_MODE))

#define QuadDec_1_PWM_UPDOWN_CNT_USED                                                            \
                ((QuadDec_1__CENTER == QuadDec_1_PWM_ALIGN)                               ||\
                 (QuadDec_1__ASYMMETRIC == QuadDec_1_PWM_ALIGN))               
        
#define QuadDec_1_PWM_PR_INIT_VALUE              (1u)
#define QuadDec_1_QUAD_PERIOD_INIT_VALUE         (0x8000u)
